const Provider = require('../library/structures/Provider');
const Util = require('../library/util/Util');
...
class JsonProvider extends Provider {
	...
	constructor(...args) {
		super(...args);
		this.baseDirectory = resolve(this.client.userBaseDirectory, 'cache', 'provider', 'json');
	}

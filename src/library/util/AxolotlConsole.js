...
/**
 * Axolotl's console class, extends NodeJS Console class.
 */
class AxolotlConsole extends Console {
	...
	/**
	 * Constructs our Axolotl instance
	 * @since 0.4.0
	 * @param {ConsoleOptions} [options] The options for the Axolotl Console
	 */
	constructor(options = {}) {
